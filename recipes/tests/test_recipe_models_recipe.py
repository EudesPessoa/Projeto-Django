from .test_tecipe_base import RecipeTestBase, Recipe
...
class RecipeModelTest(RecipeTestBase):
    ...
    def test_recipe_preparation_step_is_html_is_false_y_default(self):
    ...
    def test_recipe_is_published_is_false_y_default(self):
        recipe = self.make_recipe_no_defaults()
        self.assertFalse(
            recipe.is_published, 
